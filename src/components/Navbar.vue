<template>
    <nav class="navbar navbar-container navbar-expand-md">
        <div class="container">
            ...
            <div>
                <v-avatar
                    image="../src/assets/user-icon.jpg"
                    size="40"
                ></v-avatar>
                <h3 v-html="username" :style="{ color: 'white' }"></h3>
            </div>
...
const { isLoggedIn, loggedUser } = storeToRefs(store);
const username = loggedUser.value.toUpperCase().split(" ")[0];
console.log(username, "======");
const avatar = "https://avatars0.githubusercontent.com/u/9064066?v=4&s=460";
const title = "Welcome to Vuetify!";
const excerpt = "Thank you for joining our community...";
function logout() {
